...
using ADProjGp2_LogicUStationeryStore;
...
namespace ADProjGp2_LogicUStationeryStore.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "supplierId,gstNumber,supplierName,contactName,phone,faxNumber,address")] Supplier supplier)
        {
            if (ModelState.IsValid)
            {
